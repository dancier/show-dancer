...
@Component({
  ...
  template: `<!-- eslint-disable @angular-eslint/template/cyclomatic-complexity -->
    <div class="mx-auto my-12 max-w-[1200px] px-4 md:px-10">
      ...
      @if (chatState.chatsFetchState() === 'loaded') {
        @if (chatState.chats().length > 0) {
          ...
          <div class="">
            ...
            <p class="text-gray-500">
              Schaue dir deine Empfehlungen an, um Nutzer zu finden, denen du
              eine Nachricht schreiben kannst.
            </p>
            <p class="text-gray-500">
      ...
      @if (chatState.chatsFetchState() === 'error') {
            ...
            @for (_ of [].constructor(4); track $index) {
              <div class="flex items-center">
                ...
                <div class="flex flex-grow flex-col gap-2 px-4 py-2">
                  <div
                    class="h-6 w-full animate-pulse rounded bg-gray-400"
                  ></div>
                  <div
                    class="h-4 w-3/4 animate-pulse rounded bg-gray-300"
                  ></div>
                </div>
              </div>
            }
