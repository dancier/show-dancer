...
@Component({
  ...
  template: `
    @if (environment.getEnvironment().enableDevTools) {
      <div class="fixed bottom-4 right-4 z-50">
        ...
        @if (isExpanded()) {
          <div class="dev-panel" (clickOutside)="closePanel()">
            ...
            <div class="border-t border-gray-600 pt-4">
              <div class="flex items-center gap-2 mb-3">
                ...
                <span
                  [class]="isLoggedIn() ? 'text-green-400' : 'text-red-400'"
                >
              ...
              <button
                [class]="
                  isLoggedIn() ? 'dev-button-danger' : 'dev-button-success'
                "
                (click)="toggleAuth()"
              >
                <span
                  [innerHTML]="
                    isLoggedIn() ? '🔒 Logout' : '🔓 Login as Dev User'
                  "
                ></span>
              </button>
            </div>
